...
const DashSidebar = () => {
  ...
  const isActive = (name) =>
    active === name || parentMap[active] === name;
      ...
      <div className="flex flex-col items-center gap-6">
        ...
        <nav className="flex flex-col gap-2 items-center">
          ...
          >
            ...
            {hoverMenu === "user" && (
              <div className="absolute left-full top-0 ml-6 w-56 bg-white shadow-xl rounded-xl p-4 z-50">
                <div onClick={() => navigate("/allproviders")} className="p-2 hover:bg-darkgreen  hover:text-white rounded-2xl flex gap-2 cursor-pointer">
                  <IoIosMan /> Provider
                </div>
                <div onClick={() => navigate("/view-parent")} className="p-2 hover:bg-darkgreen  hover:text-white rounded-2xl flex gap-2 cursor-pointer">
                  <RiParentFill /> Parent
                </div>
                <div onClick={() => navigate("/centre")} className="p-2 hover:bg-darkgreen  hover:text-white rounded-2xl flex gap-2 cursor-pointer">
                  <RiParentFill /> Centre
                </div>
                 {role === "Super Admin" && (
                 <div onClick={() => navigate("/create-admin")} className="p-2 hover:bg-darkgreen  hover:text-white rounded-2xl flex gap-2 cursor-pointer">
                  <HiUserAdd />Create User
                </div>
                  )}
              </div>
            )}
          ...
          >
            ...
            {hoverMenu === "content" && (
              <div className="absolute left-full top-0 ml-6 w-56 bg-white shadow-xl rounded-xl p-4 z-50">
                <div onClick={() => navigate("/viewcat")} className="p-2 hover:bg-darkgreen  hover:text-white rounded-2xl flex gap-2 cursor-pointer">
                  <TbCategoryPlus /> Categories
                </div>
                <div onClick={() => navigate("/viewarticle")} className="p-2 hover:bg-darkgreen  hover:text-white rounded-2xl flex gap-2 cursor-pointer">
                  <TbLogs /> Articles
                </div>
              </div>
            )}
          ...
          >
            ...
            {hoverMenu === "assessment" && (
              <div className="absolute left-full top-0 ml-6 w-56 bg-white shadow-xl rounded-xl p-4 z-50">
                <div onClick={() => navigate("/addassessment")} className="p-2 hover:bg-darkgreen  hover:text-white rounded-2xl cursor-pointer">
                  Add Assessment
                </div>
                <div onClick={() => navigate("/providerassessment")} className="p-2 hover:bg-darkgreen  hover:text-white rounded-2xl cursor-pointer">
          ...
          {iconBtn("Master Data", < RiMastercardFill />, () => navigate("/master"))}
