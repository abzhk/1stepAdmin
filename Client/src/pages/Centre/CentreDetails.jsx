  ...
  return (
    <div className="p-6 bg-offwhite min-h-screen">
                  ...
                  >
                    <span
                      className={`w-1.5 h-1.5 rounded-full ${
                        centre.isActive ? "bg-green-500" : "bg-red-500"
                      }`}
                    />
              ...
              <div className="group rounded-xl bg-offwhite border border-gray-100 p-4   transition">
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-sm font-medium text-gray-800 mt-1">
                      {centre.experience ? `${centre.experience} Years` : "-"}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="group rounded-xl bg-offwhite border border-gray-100 p-4 transition">
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-sm font-medium text-gray-800 mt-1">
                      {centre.regularPrice ? `₹${centre.regularPrice}` : "-"}
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">Centre location</p>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">Areas of specialization</p>
              </div>
            </div>
      ...
      <div className="bg-white rounded-2xl shadow overflow-hidden mt-4">
        <div className="p-4 ">
          <h2 className="text-outerheader">Invited Providers</h2>
        </div>
        <div className="p-4">
